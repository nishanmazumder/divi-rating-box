	...
	class DIFL_IconListItem extends ET_Builder_Module {
			...
			return array(
				'general'  => array(
					'toggles' => array(
						...
						'child_lottie_element'  => esc_html__( 'Lottie', 'divi_flash' ),
						'child_tooltip_element' => esc_html__( 'Tooltip', 'divi_flash' ),
						'admin_label'           => array(
				...
				'advanced' => array(
					'toggles' => array(
						...
						'child_lottie_element'  => esc_html__( 'Lottie Styles', 'divi_flash' ),
		...
		public function get_fields() {
			...
			$lottie_fields                = array(
				'list_item_icon_lottie_src_type'   => array(
					'label'            => esc_html__( 'Source Type', 'divi_flash' ),
					'description'      => esc_html__( 'Choose a source type to display from your lottie.',
					                                  'divi_flash' ),
					'type'             => 'select',
					'option_category'  => 'layout',
					'options'          => array(
						'select' => esc_html__( 'Select type', 'divi_flash' ),
						'remote' => esc_html__( 'External url', 'divi_flash' ),
				...
				'list_item_icon_lottie_src_upload' => array(
					...
					'type'               => 'upload',
					'option_category'    => 'basic_option',
					'upload_button_text' => esc_attr__( 'Upload a lottie json file', 'divi_flash' ),
					'choose_text'        => esc_attr__( 'Choose a lottie json file', 'divi_flash' ),
					'update_text'        => esc_attr__( 'Set As a lottie json', 'divi_flash' ),
					'tab_slug'           => 'general',
					'toggle_slug'        => 'child_image_icon',
					'data_type'          => 'json',
			...
			$lottie_animation_fields      = array(
				'list_item_icon_lottie_trigger_method'  => array(
					'label'            => esc_html__( 'Interaction', 'divi_flash' ),
					'description'      => esc_html__(
						'Here you can choose interactivity with your Lottie animation.',
						'divi_flash'
					),
					'type'             => 'select',
					'option_category'  => 'layout',
					'options'          => array(
						'hover'        => esc_html__( 'Play on hover/mouse over', 'divi_flash' ),
						'click'        => esc_html__( 'Play on click', 'divi_flash' ),
						'freeze-click' => esc_html__( 'Freeze on click', 'divi_flash' ),
						'play-once'    => esc_html__( 'Play once', 'divi_flash' ),
					),
				...
				'list_item_icon_lottie_mouseout_action' => array(
					'label'            => esc_html__( 'On Mouseout Action', 'divi_flash' ),
					'type'             => 'select',
					'option_category'  => 'layout',
					'options'          => array(
						'no_action' => esc_html__( 'No action', 'divi_flash' ),
						'reverse'   => esc_html__( 'Reverse', 'divi_flash' ),
					),
					'default_on_front' => 'no_action',
					'show_if'          => array(
						'list_item_icon_type'                  => 'lottie',
						'list_item_icon_lottie_trigger_method' => array( 'hover' ),
						'list_item_icon_lottie_click_action'   => array( 'no_action', 'lock' ),
					),
					'tab_slug'         => 'general',
					'toggle_slug'      => 'child_lottie_element',
				),
				'list_item_icon_lottie_click_action'    => array(
					'label'            => esc_html__( 'On Click Action', 'divi_flash' ),
					'type'             => 'select',
					'option_category'  => 'layout',
					'options'          => array(
						'no_action' => esc_html__( 'No action', 'divi_flash' ),
						'lock'      => esc_html__( 'Lock animation', 'divi_flash' ),
					),
					'default_on_front' => 'no_action',
					'show_if'          => array(
						'list_item_icon_type'                   => 'lottie',
						'list_item_icon_lottie_mouseout_action' => 'reverse',
						'list_item_icon_lottie_trigger_method'  => array( 'hover' ),
					),
					'tab_slug'         => 'general',
					'toggle_slug'      => 'child_lottie_element',
				),
				'list_item_icon_lottie_autoplay'        => array(
					'label'            => esc_html__( 'Autoplay', 'divi_flash' ),
					'description'      => esc_html__(
						'Here you can choose whether or not your Lottie will autoplay on load.',
						'divi_flash'
					),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					...
					'show_if'          => array(
						'list_item_icon_type'                  => 'lottie',
						'list_item_icon_lottie_play_on_hover'  => 'off',
						'list_item_icon_lottie_trigger_method' => array( 'freeze-click', 'play-once' ),
					),
				),
				'list_item_icon_lottie_play_on_hover'   => array(
					'label'            => esc_html__( 'Play On Hover', 'divi_flash' ),
					'description'      => esc_html__(
						'Here you can choose whether or not your Lottie will animate on hover.',
						'divi_flash'
					),
					'type'             => 'yes_no_button',
					'option_category'  => 'configuration',
					...
					'show_if'          => array(
						'list_item_icon_type'                  => 'lottie',
						'list_item_icon_lottie_trigger_method' => array( 'play-once' ),
					),
				),
				'list_item_icon_lottie_loop'            => array(
					...
					'show_if_not'      => array(
						'list_item_icon_lottie_trigger_method' => array( 'play-once', 'freeze-click' ),
					),
				),
				'list_item_icon_lottie_loop_no_times'   => array(
					'label'            => esc_html__( 'Number of times', 'divi_flash' ),
					'description'      => esc_html__(
						'This option is only available if Yes is selected for Loop. Enter the number of times you wish to have the animation loop before stopping.',
						'divi_flash'
					),
					'type'             => 'range',
					'option_category'  => 'layout',
					...
					'show_if'          => array(
						'list_item_icon_type'        => 'lottie',
						'list_item_icon_lottie_loop' => 'on',
					),
					'show_if_not'      => array(
						'list_item_icon_lottie_trigger_method' => array( 'play-once' ,'freeze-click' ),
						'list_item_icon_lottie_play_on_hover'  => 'on',
					),
					'tab_slug'         => 'general',
					'toggle_slug'      => 'child_lottie_element',
				),
				'list_item_icon_lottie_delay'           => array(
					...
					'description'      => esc_html__( 'Delay the lottie animation (in ms).', 'divi_flash' ),
					'type'             => 'range',
					'option_category'  => 'configuration',
					'default_on_front' => '0',
					'validate_unit'    => false,
				...
				'list_item_icon_lottie_mode'            => array(
					'label'            => esc_html__( 'Play Mode', 'divi_flash' ),
					'description'      => esc_html__(
						'Here you can choose play mode for your Lottie animation.',
						'divi_flash'
					),
					'type'             => 'select',
					'option_category'  => 'layout',
					'options'          => array(
						...
						'bounce' => esc_html__( 'Reverse on complete', 'divi_flash' ),
					),
					...
					'show_if'          => array(
						'list_item_icon_type'            => 'lottie',
						'list_item_icon_lottie_renderer' => array( 'svg', 'canvas' ),
					),
				),
				'list_item_icon_lottie_direction'       => array(
					'label'            => esc_html__( 'Direction', 'divi_flash' ),
					'description'      => esc_html__(
						'Here you can choose play direction for your Lottie animation.',
						'divi_flash'
					),
					'type'             => 'select',
					'option_category'  => 'layout',
					'options'          => array(
						'1'  => esc_html__( 'Normal', 'divi_flash' ),
						'-1' => esc_html__( 'Reverse', 'divi_flash' ),
					),
					'default_on_front' => '1',
					'tab_slug'         => 'general',
					'toggle_slug'      => 'child_lottie_element',
				...
				'list_item_icon_lottie_renderer'        => array(
					'label'            => esc_html__( 'Render', 'divi_flash' ),
					'description'      => esc_html__(
					...
					'options'          => array(
						...
						'html'   => esc_html__( 'Html', 'divi_flash' ),
					),
			...
			$icon_image_associated_fields = array(
				...
				'list_item_icon_alignment'          => array(
					...
					'show_if_not'     => array(
						...
						'list_item_icon_lottie_renderer' => 'html',
					),
				),
		...
		public function get_advanced_fields_config() {
			...
			$advanced_fields['filters'] = array(
				'child_filters_target' => array(
					'tab_slug'    => 'advanced',
					'toggle_slug' => 'child_icon_element_filter',
					'show_if'     => array(
		...
		public function get_transition_fields_css_props() {
			...
			$fields = $this->df_background_transition(
				array(
					'fields'   => $fields,
					'key'      => 'list_item_content_background',
					'selector' => "$this->main_css_element span.difl_icon_item_container .difl_icon_item_body",
				)
			);
			$fields = $this->df_background_transition(
				array(
			...
			$fields['background_layout'] = array(
				'color' => "$this->main_css_element .difl_icon_item_header, $this->main_css_element .difl_icon_item_description",
			);

			$fields['body_text_color'] = array(
				'color' => "$this->main_css_element .difl_icon_item_description",
			);
			...
			if ( $this->props['list_item_icon_only'] === 'off' ) {
				...
				$this->df_process_bg(
					array(
						...
						'selector'    => "$this->main_css_element .item-elements span.difl_icon_item_container .difl_icon_item_body",
						'hover'       => "$this->main_css_element .item-elements:hover span.difl_icon_item_container .difl_icon_item_body",
					)
				);
				$this->df_process_bg(
					array(
		...
		private function render_item_icon_lottie( $multi_view ) {
			if ( $this->props['list_item_icon_type'] === 'lottie'
				...
				// General Settings
				$play_play_mode  = isset( $this->props['list_item_icon_lottie_mode'] ) ? $this->props['list_item_icon_lottie_mode'] : 'normal';
				...
				$play_direction  = isset( $this->props['list_item_icon_lottie_direction'] ) ? $this->props['list_item_icon_lottie_direction'] : '1';

				// Conditional Settings
				$auto_play           = isset( $this->props['list_item_icon_lottie_autoplay'] ) ? $this->props['list_item_icon_lottie_autoplay'] : 'on';
				$play_on_hover       = isset( $this->props['list_item_icon_lottie_play_on_hover'] ) ? $this->props['list_item_icon_lottie_play_on_hover'] : 'off';
				$play_loop           = isset( $this->props['list_item_icon_lottie_loop'] ) ? $this->props['list_item_icon_lottie_loop'] : 'off';
				$play_trigger_method = isset( $this->props['list_item_icon_lottie_trigger_method'] ) ? $this->props['list_item_icon_lottie_trigger_method'] : 'freeze-click';
				$play_loop_no_times  = isset( $this->props['list_item_icon_lottie_loop_no_times'] ) ? $this->props['list_item_icon_lottie_loop_no_times'] : '0';

				// Interactivity Settings
				$play_with_interactivity = isset( $this->props['list_item_icon_lottie_interactivity'] ) ? $this->props['list_item_icon_lottie_interactivity'] : 'off';
				$play_with_delay         = isset( $this->props['list_item_icon_lottie_delay'] ) ? $this->props['list_item_icon_lottie_delay'] : '0';
				$anim_mouse_out_event    = isset( $this->props['list_item_icon_lottie_mouseout_action'] ) ? $this->props['list_item_icon_lottie_mouseout_action'] : 'no_action';
				$anim_click_event        = isset( $this->props['list_item_icon_lottie_click_action'] ) ? $this->props['list_item_icon_lottie_click_action'] : 'no_action';


				$is_allowed_autoplay = in_array( $play_trigger_method, array( 'freeze-click', 'play-once' ), true );
				$is_allowed_loop     = ! in_array( $play_trigger_method, array( 'freeze-click', 'play-once' ), true );
				$is_allowed_hover     = $play_trigger_method === 'play-once';

				$lottie_image_options = array(
					// General Options
					'renderer'      => $output_renderer,
					'speed'         => (int) $play_speed,
					'direction'     => (int) $play_direction,

					// Conditional Options
					'autoplay'      => $auto_play === 'on' && $play_on_hover === 'off' && $is_allowed_autoplay,
					'loop'          => $play_loop !== 'off' && $is_allowed_loop,
					'hover'         => $play_on_hover === 'on' && $is_allowed_hover,

					// Interactive Options
					'delay'         => (int) $play_with_delay,
					'mode'          => $play_play_mode,
					'interactivity' => $play_with_interactivity,
					'interaction'   => $play_trigger_method,
				);

				// Set a number for a specific amount of loops.
				if ( $play_loop === 'on' && $play_loop_no_times !== 0 && $play_on_hover === 'off' ) {
					$lottie_image_options['loop_play_times'] = (int) $play_loop_no_times;
				}

				// Set mouse out event for hover interactivity with lottie image.
				if ( $play_trigger_method === 'hover' && $anim_mouse_out_event !== 'no_action' ) {
					$lottie_image_options['mouse_out_event'] = $anim_mouse_out_event;
				}

				// Set click event for hover interactivity with lottie image.
				if ( $play_trigger_method === 'hover' && $anim_mouse_out_event === 'reverse' && $anim_click_event !== 'no_action' ) {
					$lottie_image_options['click_event'] = $anim_click_event;
				}
