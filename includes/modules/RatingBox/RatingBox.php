...
class DIFL_RatingBox extends ET_Builder_Module
{
    ...
    public function init()
    {
        ...
        $this->icon_path        =  DIFL_ADMIN_DIR_PATH . 'img/module-icons/start-rating.svg';
    }
    ...
    public function get_advanced_fields_config()
    {
        ...
        $advanced_fields['fonts'] = [
            ...
            'design_content_text'   => array(
                ...
                'css'       => array(
                    'main'  => "$this->main_css_element .df_rating_content p",
                    'hover' => "$this->main_css_element .df_rating_content p:hover",
                    'important' => 'all',
                ),
                // Content design
    ...
    public function df_render_rating_wrapper()
    {
        ...
        $rating_value_single = $this->props['rating_scale_type'] === "5"
            ? $this->props['rating_value_5']
            : $this->props['rating_value_10'];
