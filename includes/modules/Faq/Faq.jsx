...
class Faq extends Component {
  ...
  render_que_icon = (props, utils) =>{
    ...
    return(
      <div className="faq_icon">
        {this.state.active ? close_icon_html : open_icon_html}
      </div>
    )
  }
  // prettier-ignore
    ...
    if('on' === props.enable_question_image){
      return (
        <div className="faq_question_image">
          {this.state.active ? close_image_html : open_image_html}
        </div>
      )
    }
  ...
  df_faq_question = (child_props) => {
    ...
    return (
      <div className="faq_question_wrapper" onClick={this.handleFaqToggle}>
  ...
  df_faq_answer = (child_props) => {
   ...
   const AnsBtnHtml = this.render_button(child_props)
    ...
    return (
      this.state.active && <div className="faq_answer_wrapper">
  ...
  render() {
    return (
      <div className="df_faq_wrapper">
        ...
        {this.props.content.length !== 0 ? this.props.content : ""}
      </div>
    );
  }
}
